...
newPart.addTag("oompIndex", "TO-92L_Inline")
newPart.addTag("oompName", "kicad-footprints/Package_TO_SOT_THT/TO-92L_Inline")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_TO_SOT_THT.3dshapes/TO-92L_Inline.wrl")
