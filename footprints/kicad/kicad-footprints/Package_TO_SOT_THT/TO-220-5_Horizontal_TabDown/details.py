...
newPart.addTag("oompIndex", "TO-220-5_Horizontal_TabDown")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_TO_SOT_THT.3dshapes/TO-220-5_Horizontal_TabDown.wrl")
