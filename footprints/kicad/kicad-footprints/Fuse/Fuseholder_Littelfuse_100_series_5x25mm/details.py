...
newPart.addTag("oompIndex", "Fuseholder_Littelfuse_100_series_5x25mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Fuse.3dshapes/Fuseholder_Littelfuse_100_series_5x25mm.wrl")
