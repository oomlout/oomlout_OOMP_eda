...
newPart.addTag("oompIndex", "Transformer_Coilcraft_CST2")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Transformer_SMD.3dshapes/Transformer_Coilcraft_CST.wrl")
