...
newPart.addTag("oompIndex", "LED_miniPLCC_2315_Handsoldering")
newPart.addTag("oompName", "kicad-footprints/LED_SMD/LED_miniPLCC_2315_Handsoldering")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/LED_SMD.3dshapes/LED_miniPLCC_2315.wrl")
