...
newPart.addTag("oompIndex", "SolderWire-0.75sqmm_1x03_P4.8mm_D1.25mm_OD2.3mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-0.75sqmm_1x03_P4.8mm_D1.25mm_OD2.3mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-0.75sqmm_1x03_P4.8mm_D1.25mm_OD2.3mm.wrl")
