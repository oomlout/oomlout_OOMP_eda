...
newPart.addTag("oompIndex", "SolderWire-2.5sqmm_1x01_D2.4mm_OD4.4mm_Relief")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-2.5sqmm_1x01_D2.4mm_OD4.4mm_Relief")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-2.5sqmm_1x01_D2.4mm_OD4.4mm_Relief.wrl")
