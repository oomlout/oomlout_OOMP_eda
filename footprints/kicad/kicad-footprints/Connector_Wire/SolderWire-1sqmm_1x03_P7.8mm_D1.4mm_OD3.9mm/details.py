...
newPart.addTag("oompIndex", "SolderWire-1sqmm_1x03_P7.8mm_D1.4mm_OD3.9mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-1sqmm_1x03_P7.8mm_D1.4mm_OD3.9mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-1sqmm_1x03_P7.8mm_D1.4mm_OD3.9mm.wrl")
