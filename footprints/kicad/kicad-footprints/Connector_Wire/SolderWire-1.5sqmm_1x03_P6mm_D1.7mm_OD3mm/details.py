...
newPart.addTag("oompIndex", "SolderWire-1.5sqmm_1x03_P6mm_D1.7mm_OD3mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-1.5sqmm_1x03_P6mm_D1.7mm_OD3mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-1.5sqmm_1x03_P6mm_D1.7mm_OD3mm.wrl")
