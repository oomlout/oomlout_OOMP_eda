...
newPart.addTag("oompIndex", "SolderWire-0.1sqmm_1x03_P3.6mm_D0.4mm_OD1mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-0.1sqmm_1x03_P3.6mm_D0.4mm_OD1mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-0.1sqmm_1x03_P3.6mm_D0.4mm_OD1mm.wrl")
