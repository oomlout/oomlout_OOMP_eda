...
newPart.addTag("oompIndex", "SolderWire-0.127sqmm_1x01_D0.48mm_OD1mm_Relief2x")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-0.127sqmm_1x01_D0.48mm_OD1mm_Relief2x")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-0.127sqmm_1x01_D0.48mm_OD1mm_Relief2x.wrl")
