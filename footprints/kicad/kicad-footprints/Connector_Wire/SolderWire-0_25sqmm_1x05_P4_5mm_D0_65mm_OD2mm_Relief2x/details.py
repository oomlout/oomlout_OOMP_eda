...
newPart.addTag("oompIndex", "SolderWire-0.25sqmm_1x05_P4.5mm_D0.65mm_OD2mm_Relief2x")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-0.25sqmm_1x05_P4.5mm_D0.65mm_OD2mm_Relief2x")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-0.25sqmm_1x05_P4.5mm_D0.65mm_OD2mm_Relief2x.wrl")
