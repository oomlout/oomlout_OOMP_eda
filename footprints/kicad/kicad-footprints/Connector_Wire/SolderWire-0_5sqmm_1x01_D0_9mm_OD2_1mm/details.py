...
newPart.addTag("oompIndex", "SolderWire-0.5sqmm_1x01_D0.9mm_OD2.1mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-0.5sqmm_1x01_D0.9mm_OD2.1mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-0.5sqmm_1x01_D0.9mm_OD2.1mm.wrl")
