...
newPart.addTag("oompIndex", "SolderWire-1sqmm_1x01_D1.4mm_OD2.7mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Wire/SolderWire-1sqmm_1x01_D1.4mm_OD2.7mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Wire.3dshapes/SolderWire-1sqmm_1x01_D1.4mm_OD2.7mm.wrl")
