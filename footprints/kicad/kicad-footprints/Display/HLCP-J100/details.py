...
newPart.addTag("oompIndex", "HLCP-J100")
newPart.addTag("oompName", "kicad-footprints/Display/HLCP-J100")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Display.3dshapes/HLCP-J100.wrl")
