...
newPart.addTag("oompIndex", "PowerIntegrations_SMD-8")
newPart.addTag("oompName", "kicad-footprints/Package_DIP/PowerIntegrations_SMD-8")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_DIP.3dshapes/PowerIntegrations_SMD-8.wrl")
