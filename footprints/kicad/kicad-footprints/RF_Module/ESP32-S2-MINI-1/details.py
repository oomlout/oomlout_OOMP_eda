...
newPart.addTag("oompIndex", "ESP32-S2-MINI-1")
newPart.addTag("oompName", "kicad-footprints/RF_Module/ESP32-S2-MINI-1")
...
newPart.addTag("kicadTags", "2.4 GHz Wi-Fi Bluetooth external antenna espressif  20*15.4mm")
