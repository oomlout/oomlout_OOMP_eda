...
newPart.addTag("oompIndex", "ESP32-S3-WROOM-1")
newPart.addTag("oompName", "kicad-footprints/RF_Module/ESP32-S3-WROOM-1")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/RF_Module.3dshapes/ESP32-S3-WROOM-1.wrl")
