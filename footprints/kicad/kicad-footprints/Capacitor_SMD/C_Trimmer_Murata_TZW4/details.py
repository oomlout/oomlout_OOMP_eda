...
newPart.addTag("oompIndex", "C_Trimmer_Murata_TZW4")
...
newPart.addTag("kicadTags", "Murata TZW4")
newPart.addTag("kicadAttr", "smd")
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Capacitor_SMD.3dshapes/C_Trimmer_Murata_TZW4.wrl")
