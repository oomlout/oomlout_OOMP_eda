...
newPart.addTag("oompIndex", "Converter_DCDC_Cincon_EC5BExx_Dual_THT")
newPart.addTag("oompName", "kicad-footprints/Converter_DCDC/Converter_DCDC_Cincon_EC5BExx_Dual_THT")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Converter_DCDC.3dshapes/Converter_DCDC_Cincon_EC5BExx_Dual_THT.wrl")
