...
newPart.addTag("oompIndex", "Polarity_Center_Positive_30mm_SilkScreen")
newPart.addTag("oompName", "kicad-footprints/Symbol/Polarity_Center_Positive_30mm_SilkScreen")
