...
newPart.addTag("oompIndex", "Polarity_Center_Positive_8mm_SilkScreen")
newPart.addTag("oompName", "kicad-footprints/Symbol/Polarity_Center_Positive_8mm_SilkScreen")
