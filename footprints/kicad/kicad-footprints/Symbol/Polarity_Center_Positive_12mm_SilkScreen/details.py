...
newPart.addTag("oompIndex", "Polarity_Center_Positive_12mm_SilkScreen")
newPart.addTag("oompName", "kicad-footprints/Symbol/Polarity_Center_Positive_12mm_SilkScreen")
