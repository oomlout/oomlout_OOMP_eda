...
newPart.addTag("oompIndex", "DIN41612_F_2x16_Female_Vertical_THT")
newPart.addTag("oompName", "kicad-footprints/Connector_DIN/DIN41612_F_2x16_Female_Vertical_THT")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_DIN.3dshapes/DIN41612_F_2x16_Female_Vertical_THT.wrl")
