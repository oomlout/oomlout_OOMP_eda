...
newPart.addTag("oompIndex", "LED_D5.0mm-4_RGB")
newPart.addTag("oompName", "kicad-footprints/LED_THT/LED_D5.0mm-4_RGB")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/LED_THT.3dshapes/LED_D5.0mm-4_RGB.wrl")
