...
newPart.addTag("oompIndex", "LED_D5.0mm_Clear")
newPart.addTag("oompName", "kicad-footprints/LED_THT/LED_D5.0mm_Clear")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/LED_THT.3dshapes/LED_D5.0mm_Clear.wrl")
