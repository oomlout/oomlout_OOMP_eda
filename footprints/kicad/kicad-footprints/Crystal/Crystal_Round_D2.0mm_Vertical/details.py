...
newPart.addTag("oompIndex", "Crystal_Round_D2.0mm_Vertical")
newPart.addTag("oompName", "kicad-footprints/Crystal/Crystal_Round_D2.0mm_Vertical")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Crystal.3dshapes/Crystal_Round_D2.0mm_Vertical.wrl")
