...
newPart.addTag("oompIndex", "Texas_WQFN-MR-100_ThermalVias_3x3-DapStencil")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_DFN_QFN.3dshapes/Texas_WQFN-MR-100.wrl")
