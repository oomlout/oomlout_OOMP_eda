...
newPart.addTag("oompIndex", "VQFN-32-1EP_5x5mm_P0.5mm_EP3.5x3.5mm_ThermalVias")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_DFN_QFN.3dshapes/VQFN-32-1EP_5x5mm_P0.5mm_EP3.5x3.5mm.wrl")
