...
newPart.addTag("oompIndex", "QFN-38-1EP_4x6mm_P0.4mm_EP2.65x4.65mm_ThermalVias")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_DFN_QFN.3dshapes/QFN-38-1EP_4x6mm_P0.4mm_EP2.65x4.65mm.wrl")
