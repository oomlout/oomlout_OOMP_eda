...
newPart.addTag("oompIndex", "DSUB-25_Female_Vertical_P2.77x2.84mm")
newPart.addTag("oompName", "kicad-footprints/Connector_Dsub/DSUB-25_Female_Vertical_P2.77x2.84mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Dsub.3dshapes/DSUB-25_Female_Vertical_P2.77x2.84mm.wrl")
