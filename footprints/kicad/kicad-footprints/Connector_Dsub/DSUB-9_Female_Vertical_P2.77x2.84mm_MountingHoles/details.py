...
newPart.addTag("oompIndex", "DSUB-9_Female_Vertical_P2.77x2.84mm_MountingHoles")
newPart.addTag("oompName", "kicad-footprints/Connector_Dsub/DSUB-9_Female_Vertical_P2.77x2.84mm_MountingHoles")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Connector_Dsub.3dshapes/DSUB-9_Female_Vertical_P2.77x2.84mm_MountingHoles.wrl")
