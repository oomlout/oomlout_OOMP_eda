...
newPart.addTag("oompIndex", "TerminalBlock_RND_205-00277_1x03_P5.00mm_Vertical")
...
newPart.addTag("kicadTags", "THT terminal block RND 205-00079 vertical pitch 5mm size 15x10mm^2 drill 1.3mm pad 2.5mm")
newPart.addTag("kicadAttr", "through_hole")
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/TerminalBlock_RND.3dshapes/TerminalBlock_RND_205-00277_1x03_P5.00mm_Vertical.wrl")
