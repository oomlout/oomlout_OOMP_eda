...
newPart.addTag("oompIndex", "TO-263-5_TabPin3")
newPart.addTag("oompName", "kicad-footprints/Package_TO_SOT_SMD/TO-263-5_TabPin3")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_TO_SOT_SMD.3dshapes/TO-263-5_TabPin3.wrl")
