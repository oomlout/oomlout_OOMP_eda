...
newPart.addTag("oompIndex", "Infineon_PG-TISON-8-2")
newPart.addTag("oompName", "kicad-footprints/Package_SON/Infineon_PG-TISON-8-2")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_SON.3dshapes/Infineon_PG-TISON-8-2.wrl")
