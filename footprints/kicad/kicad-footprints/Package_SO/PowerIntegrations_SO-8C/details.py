...
newPart.addTag("oompIndex", "PowerIntegrations_SO-8C")
newPart.addTag("oompName", "kicad-footprints/Package_SO/PowerIntegrations_SO-8C")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_SO.3dshapes/PowerIntegrations_SO-8C.wrl")
