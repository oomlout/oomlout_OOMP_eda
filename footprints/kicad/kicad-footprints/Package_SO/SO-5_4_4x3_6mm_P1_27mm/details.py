...
newPart.addTag("oompIndex", "SO-5_4.4x3.6mm_P1.27mm")
newPart.addTag("oompName", "kicad-footprints/Package_SO/SO-5_4.4x3.6mm_P1.27mm")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Package_SO.3dshapes/SO-5_4.4x3.6mm_P1.27mm.wrl")
