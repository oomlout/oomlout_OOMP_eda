...
newPart.addTag("oompIndex", "D_2512_6332Metric")
newPart.addTag("oompName", "kicad-footprints/Diode_SMD/D_2512_6332Metric")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Diode_SMD.3dshapes/D_2512_6332Metric.wrl")
