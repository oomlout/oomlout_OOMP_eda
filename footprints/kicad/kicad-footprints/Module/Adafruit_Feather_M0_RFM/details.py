...
newPart.addTag("oompIndex", "Adafruit_Feather_M0_RFM")
newPart.addTag("oompName", "kicad-footprints/Module/Adafruit_Feather_M0_RFM")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Module.3dshapes/Adafruit_Feather_M0_RFM.wrl")
