...
newPart.addTag("oompIndex", "D_DO-201AD_P5.08mm_Vertical_KathodeUp")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Diode_THT.3dshapes/D_DO-201AD_P5.08mm_Vertical_KathodeUp.wrl")
