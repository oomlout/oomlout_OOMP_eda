...
newPart.addTag("oompIndex", "D_DO-15_P5.08mm_Vertical_AnodeUp")
newPart.addTag("oompName", "kicad-footprints/Diode_THT/D_DO-15_P5.08mm_Vertical_AnodeUp")
...
newPart.addTag("kicad3DModel", "${KICAD6_3DMODEL_DIR}/Diode_THT.3dshapes/D_DO-15_P5.08mm_Vertical_AnodeUp.wrl")
